- dashboard: kamil_superstore_kpi_dashboard
  title: Kamil Superstore KPI Dashboard
  layout: newspaper
  ...
  - title: "% of returned orders"
    ...
    type: single_value
    fields: [returns.total_returned_orders, orders.total_orders]
    limit: 5000
    column_limit: 50
    dynamic_fields:
    - category: table_calculation
      expression: "${returns.total_returned_orders}/${orders.total_orders}"
    ...
    value_labels: legend
    label_type: labPer
    hidden_fields: [returns.total_returned_orders, orders.total_orders]
    hidden_points_if_no: []
  ...
  - title: Number of Orders by Manager
    ...
    explore: kamil_orders
    type: looker_bar
    fields: [people.person, orders.total_orders]
